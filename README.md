...
The extracted data is stored in the `fire_stations.csv` file, which contains the station names and their corresponding geocodes (latitude and longitude).
